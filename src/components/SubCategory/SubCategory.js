    ...
    <div className="sub-category" ref={divRef}>
      ...
      <Switch>
        <Route exact path={`${url}/`}>
          ...
          <p className="sub-category__products-length">{filterdProducts && filterdProducts.length} {filterdProducts && filterdProducts.length % 10 === 1 && 'модель'}{filterdProducts && (filterdProducts.length % 10 >= 2 && filterdProducts.length % 10 <= 4) && 'модели'}{filterdProducts && ((filterdProducts.length % 10 >= 5 && filterdProducts.length % 10 <= 9) || filterdProducts.length % 10 === 0) && 'моделей'}</p>
          ...
          <div className="sub-category__products-and-filters">
            ...
            <div className="sub-category__products-with-btn">
              ...
              }).length > 0 ? <></> : props.subcategoryPreloaderVisible ? <></> : <p className='sub-category__no-products-text'>Товары для указанных фильтров не найдены</p>}
