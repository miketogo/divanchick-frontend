...
function SubCategory(props) {
  ...
  useEffect(() => {
    if (sub_category && props.category) {
      ...
      {subcategory ?
        ...
        <Switch>
          <Route exact path={`${url}/`}>
            ...
            <FiltersPopup handleResetFilters={handleResetFilters} setFiltersUpd={props.setFiltersUpd} filters={subcategory.filters} handleUpdateByFilters={handleUpdateByFilters} handleFilterPopupClose={handleFilterPopupClose} isFilterPopupOpen={isFilterPopupOpen} />
            ...
            <div className="sub-category__products-and-filters" key={subcategory.category.translit_name}>
              <div className='sub-category__filters'>
                <Filters handleResetFilters={handleResetFilters} divRef={divRef} setFiltersUpd={props.setFiltersUpd} filters={subcategory.filters} handleUpdateByFilters={handleUpdateByFilters} />
              </div>
          ...
          <Route path={`${url}/:product_name`}>
            <ProductPage handleColorPopupOpen={props.handleColorPopupOpen} setCartPopupOpen={props.setCartPopupOpen} cart={props.cart} handleToCartBtn={props.handleToCartBtn} handleLikeBtn={props.handleLikeBtn} favouritesProducts={props.favouritesProducts} category={props.category} sub_category={subcategory} />
          </Route>
